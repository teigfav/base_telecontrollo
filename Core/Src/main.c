...
/* USER CODE BEGIN PV */
char car;
char fw_version[]="EDH-xxxxxxxxxxxxxx.00.00.00"; //major.minor.build
char hw_ctrl_version[]="CTRL.00.00.001"; //major.minor.build
char hw_rf_version[]="Base.00.00.001"; //major.minor.build
/* USER CODE END PV */
